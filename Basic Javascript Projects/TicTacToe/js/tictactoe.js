...
function placeXOrO(squareNumber) { 
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            activePlayer = 'O';
            //if acttive player is anything other than 'X'
        } else {
    ...
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        function animateLineDrawing() {
            ...
            //This method clears content from the last loop ineration.
            ...
            c.lineWidth = 10;
            //This method sets the color our our line.
        ...
        disableClick();
        //Thie line plays the win sounds.
